...
export const headingClasses = {
	noSize: 'font-semibold uppercase',
...
export const headlineClasses = {
	...
	heading3: 'text-2.5 m:text-3.2 leading-1 font-header font-bold uppercase',
	...
	heading6: 'text-2.2 leading-1 font-header font-bold uppercase',
	noSize: 'leading-1 font-header font-bold uppercase'
}

export const paragraphClasses = {
	heading1: 'text-1.6 mb-1.5',
	heading2: 'text-1.5 mb-1.4',
	heading3: 'text-1.4 mb-1.3',
	heading4: 'text-1.3 mb-1.2',
	heading5: 'text-1.2 mb-1.1',
	heading6: 'text-1.1 mb-1',
	paragraph: `text-1 mb-1`,
}